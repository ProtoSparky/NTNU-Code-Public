...
/**
 * @brief UI - Spår bruker om div info for å lage en ny rute.
 */
void nyRute() {
...
void slettRute() {								
	...
	// jeg tolket at det ikke var nådvendig utifra oppgave teksten. 
 ...
 */
void slett() {
	gRuter.clear();										  //Tåmmer hele vektoren
}
...
void slett(const int nr) {
	...
	gRuter.erase(gRuter.begin() + nr);					//Tåmmer pointer for nr 
}
