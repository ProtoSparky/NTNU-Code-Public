...
void skrivStopp();/*Skriver navnet på alle stoppestedene(som er i gBusstopp),nummerert fra 1 og oppover.*/
...
void nyRute();/* Oppretter en ny rute.Får alle dennes data lest inn vha.funksjonen nedenfor.Gikk innlesningen bra, så legges den inn bakerst i gRuter,
